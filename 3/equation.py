...
class Abc:
    def __init__(self):
        ...
        self.i3_17 = ImageTk.PhotoImage(Img.open('equation_textures.png').crop((401, 75, 425, 99)))
        self.i3_18 = ImageTk.PhotoImage(Img.open('equation_textures.png').crop((426, 75, 450, 99)))
        self.i3_19 = ImageTk.PhotoImage(Img.open('equation_textures.png').crop((451, 75, 475, 99)))
        self.i3_20 = ImageTk.PhotoImage(Img.open('equation_textures.png').crop((476, 75, 500, 99)))
        self.i3_21 = ImageTk.PhotoImage(Img.open('equation_textures.png').crop((501, 75, 525, 99)))
        ...
        self.i4_16 = ImageTk.PhotoImage(Img.open('equation_textures.png').crop((376, 100, 400, 124)))
        self.i4_17 = ImageTk.PhotoImage(Img.open('equation_textures.png').crop((401, 100, 425, 124)))
        self.i4_18 = ImageTk.PhotoImage(Img.open('equation_textures.png').crop((426, 100, 450, 124)))
        self.i4_19 = ImageTk.PhotoImage(Img.open('equation_textures.png').crop((451, 100, 475, 124)))
        self.i4_20 = ImageTk.PhotoImage(Img.open('equation_textures.png').crop((476, 100, 500, 124)))
        self.i4_21 = ImageTk.PhotoImage(Img.open('equation_textures.png').crop((501, 100, 525, 124)))
        ...
        Button(self.root, image=self.img_cpy, command=lambda: copy(self.textbox.get(0.0, END))).place(x=20, y=313)
        Button(self.root, image=self.img_nxt, command=lambda: self.textbox.insert(END, r'%\newline%')).place(x=44, y=313)
        Button(self.root, image=self.img_clr, command=lambda: self.textbox.delete(0.0, END)).place(x=68, y=313)
        Button(self.root, image=self.img_pdf, command=self.transform).place(x=92, y=313)
        self.root.mainloop()
